      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6 mb-2">
            <h1>Administración de Clientes Desabilitados</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="<?php echo base_url()?>index.php/cliente/listar">
                <i class="fas fa-list"></i>&nbsp;&nbsp;Lista de Clientes Habilitados</a>
              </li>
            </ol>
          </div>       
        </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Lista de Clientes Desabilitados</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            echo form_open_multipart('cliente/habilitarbd', $atributos);
                            ?>
