  ...
  <div class="content-wrapper">    
    <section class="content-header">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url()?>index.php/administrador/listar">
                <i class="fas fa-list"></i>&nbsp;&nbsp;Volver a la lista de Administradores</a>
              </li>
            </ol>
          </div>          
        </div>
      ...
      <div class="row mb-0">
        <div class="col-sm-12">
          <h6 class="text-danger ml-2">Solo se puede modificar los datos personales del usuario administrador.</h6>
        </div>
      </div>       
    </section>
        ...
        <div class="row">
          <div class="col-12">
            <div class="card mb-4">
              ...
              {        
              ?>              
                <form action="<?php echo base_url(); ?>index.php/administrador/modificarbd" method="POST">
                  <input type="hidden" class="form-control" name="idempleado" value="<?php echo $row->idUsuario; ?>">
                  <fieldset disabled>
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-md-6 w-100">
                      <a class="btn btn-danger btn-block" href="<?php echo base_url(); ?>index.php/administrador/listar" role="button">
